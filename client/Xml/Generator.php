...
use BankartPaymentGateway\Client\Data\Request;
...
use BankartPaymentGateway\Client\Transaction\Debit;
use BankartPaymentGateway\Client\Transaction\Deregister;
use BankartPaymentGateway\Client\Transaction\Payout;
use BankartPaymentGateway\Client\Transaction\Preauthorize;
use BankartPaymentGateway\Client\Transaction\Refund;
 ...
 * Class Generator
 *
 * @package BankartPaymentGateway\Client\Xml
 */
class Generator {
    ...
    /**
     * @param \BankartPaymentGateway\Client\Transaction\VoidTransaction $transaction
     * @param $method
     *
     * @return \DOMElement
     */
